...
@section('content')
    <form name=text_form method=POST action='{{ route('gejala.update.process') }}' onsubmit='return Blank_TextField_Validator()'>
        @csrf
        
        <input type=hidden name=id value='{{ $kode_gejala }}'>
        <br><br><table class='table table-bordered'>
        <tr><td width=120>Nama Gejala</td><td><input type=text autocomplete='off' placeholder='Masukkan gejala baru...' class='form-control' name='nama_gejala' size=30 value={{ $nama_gejala }}></td></tr>
