...
@section('content')
    ...
    @if(empty($idpkt))
        ...
        <div class='callout callout-default'>Jenis penyakit gigi dan mulut yang diderita adalah <b><h3 class='text text-success'>{{ $nmpkt[1] }}</b> {{ round($vlpkt[1], 2) }} % ({{ $vlpkt[1] }})<br></h3>
